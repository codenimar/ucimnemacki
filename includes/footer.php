        ...
        <div class="footer-grid">
            ...
            <div class="footer-brand">
                <a href="<?= SITE_URL ?>/index.php" class="footer-logo">
                    <img src="<?= SITE_URL ?>/assets/images/parrot.svg" alt="Papagaj maskota" width="40" height="40">
                    <span>Učim Nemački</span>
                </a>
                <p class="footer-tagline">Naučite nemački na zabavan,<br>interaktivan i efikasan način!</p>
            ...
            <div class="footer-col">
                <h3 class="footer-heading">Učenje</h3>
            ...
            <div class="footer-col">
                <h3 class="footer-heading">Nalog</h3>
                <ul class="footer-links">
                    <li><a href="<?= SITE_URL ?>/pages/register.php">Registruj se</a></li>
                    <li><a href="<?= SITE_URL ?>/pages/login.php">Prijavi se</a></li>
                    <li><a href="<?= SITE_URL ?>/pages/profile.php">Moj profil</a></li>
                </ul>
            </div>
            <div class="footer-col">
